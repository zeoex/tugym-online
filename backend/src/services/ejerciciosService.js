const RUTINAS_HOMBRE = [
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Patadas de Tríceps',               musculo: 'Tríceps',         series: 3, reps: '15',     descanso: '45 seg' },
      { nombre: 'Pullover con Mancuerna',           musculo: 'Pecho/Dorsal',    series: 3, reps: '12',     descanso: '60 seg' },
    ],
  },
  {
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Hip Thrust con Barra',             musculo: 'Glúteos',         series: 3, reps: '10-12',  descanso: '90 seg'  },
      { nombre: 'Plancha con Rotación',             musculo: 'Core',            series: 3, reps: '10 c/lado', descanso: '60 seg' },
    ],
  },
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Press Arnold',                     musculo: 'Hombros Completo',series: 3, reps: '12',     descanso: '60 seg' },
...
const RUTINAS_MUJER = [
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Mountain Climbers',                musculo: 'Core/Cardio',     series: 3, reps: '20 c/lado',     descanso: '60 seg' },
      { nombre: 'Plancha Lateral',                  musculo: 'Oblicuos/Core',   series: 3, reps: '30-45 seg c/lado', descanso: '45 seg' },
      { nombre: 'Dead Bug',                         musculo: 'Core Profundo',   series: 3, reps: '10 c/lado',     descanso: '45 seg' },
    ],
  },
  {
  ...
  },
  {
    ...
    ejercicios: [
      { nombre: 'Burpees Modificados',              musculo: 'Cuerpo Completo', series: 4, reps: '10',     descanso: '60 seg' },
      { nombre: 'Sentadillas con Salto',            musculo: 'Piernas/Cardio',  series: 3, reps: '15',     descanso: '60 seg' },
      { nombre: 'Mountain Climbers',                musculo: 'Core/Cardio',     series: 4, reps: '20 c/lado', descanso: '45 seg' },
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Sentadilla Plie con Mancuerna',    musculo: 'Aductores/Glúteos',series: 3, reps: '15',   descanso: '60 seg' },
    ],
  },
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Kickbacks de Tríceps',             musculo: 'Tríceps',         series: 3, reps: '15',     descanso: '45 seg' },
  ...
  },
  {
    ...
    ejercicios: [
      { nombre: 'Sentadilla con Prensa de Hombros', musculo: 'Cuerpo Completo', series: 3, reps: '12',     descanso: '75 seg' },
      ...
      { nombre: 'Plancha con Elevación de Brazo',   musculo: 'Core/Hombros',    series: 3, reps: '10 c/lado', descanso: '45 seg' },
...
const RUTINAS_PRECALENTAMIENTO = [
  {
    ...
    ejercicios: [
      { nombre: 'Rotación de Cuello',                   musculo: 'Cervical',          series: 2, reps: '10 c/lado',    descanso: '15 seg' },
      { nombre: 'Rotación de Hombros',                  musculo: 'Hombros',           series: 2, reps: '15 c/sentido', descanso: '15 seg' },
      { nombre: 'Rotación de Caderas',                  musculo: 'Cadera',            series: 2, reps: '10 c/lado',    descanso: '15 seg' },
      { nombre: 'Rotación de Tobillos',                 musculo: 'Tobillos',          series: 2, reps: '10 c/lado',    descanso: '15 seg' },
      ...
      { nombre: 'Cat-Cow en Cuadrupedia',               musculo: 'Columna/Core',      series: 2, reps: '10',           descanso: '15 seg' },
    ],
  },
  {
    nombre: 'Activación Cardiovascular',
    ejercicios: [
      { nombre: 'Trote en el Lugar',                    musculo: 'Cardio General',    series: 1, reps: '60 seg',       descanso: '15 seg' },
      { nombre: 'Jumping Jacks',                        musculo: 'Cardio/Hombros',    series: 2, reps: '30',           descanso: '20 seg' },
      { nombre: 'Skipping Alto',                        musculo: 'Cardio/Piernas',    series: 2, reps: '20 c/lado',    descanso: '20 seg' },
      { nombre: 'Sentadillas Rápidas',                  musculo: 'Piernas/Cardio',    series: 2, reps: '15',           descanso: '20 seg' },
      { nombre: 'Mountain Climbers Lentos',             musculo: 'Core/Cardio',       series: 2, reps: '10 c/lado',    descanso: '20 seg' },
      { nombre: 'Rotación de Tronco de Pie',            musculo: 'Oblicuos/Espalda',  series: 2, reps: '15 c/lado',    descanso: '15 seg' },
      { nombre: 'Talones al Glúteo',                    musculo: 'Isquios/Cardio',    series: 2, reps: '20 c/lado',    descanso: '20 seg' },
      { nombre: 'Círculos de Brazo Amplios',            musculo: 'Hombros/Cardio',    series: 2, reps: '15 c/sentido', descanso: '15 seg' },
    ],
  },
  {
    nombre: 'Estiramiento Dinámico',
    ejercicios: [
      { nombre: 'Estiramiento Dinámico de Isquiotibiales', musculo: 'Isquiotibiales',   series: 2, reps: '10 c/lado',  descanso: '15 seg' },
      { nombre: 'Apertura de Cadera Circular',          musculo: 'Cadera',            series: 2, reps: '8 c/lado',     descanso: '15 seg' },
      { nombre: 'Estocada con Elevación de Brazo',      musculo: 'Cuerpo Completo',   series: 2, reps: '8 c/lado',     descanso: '20 seg' },
      { nombre: 'Thread the Needle',                    musculo: 'Dorsal/Hombros',    series: 2, reps: '8 c/lado',     descanso: '15 seg' },
      { nombre: 'Squats to Stand',                      musculo: 'Cadera/Isquios',    series: 2, reps: '10',           descanso: '20 seg' },
      { nombre: 'Inchworm',                             musculo: 'Cuerpo Completo',   series: 2, reps: '8',            descanso: '20 seg' },
      { nombre: 'Estiramiento de Flexor de Cadera',     musculo: 'Flexores de Cadera',series: 2, reps: '30 seg c/lado',descanso: '15 seg' },
      { nombre: 'Apertura Lateral con Apoyo',           musculo: 'Aductores/Cadera',  series: 2, reps: '10 c/lado',    descanso: '15 seg' },
    ],
  },
  {
    ...
    ejercicios: [
      ...
      { nombre: 'Clamshell con Banda Elástica',         musculo: 'Glúteo Medio',      series: 2, reps: '15 c/lado',  descanso: '20 seg' },
      { nombre: 'Puente de Glúteos Activación',        musculo: 'Glúteos',           series: 2, reps: '15',         descanso: '15 seg' },
      { nombre: 'Rotación de Cadera de Pie',            musculo: 'Cadera/Core',       series: 2, reps: '10 c/lado',  descanso: '15 seg' },
      { nombre: 'Pull Apart con Banda',                 musculo: 'Hombro Posterior',  series: 2, reps: '15',         descanso: '15 seg' },
      { nombre: 'Plank Rocks Adelante-Atrás',          musculo: 'Core/Hombros',      series: 2, reps: '10',         descanso: '20 seg' },
      { nombre: 'Sentadilla Isométrica en Pared',       musculo: 'Cuádriceps',        series: 2, reps: '30 seg',     descanso: '30 seg' },
      { nombre: 'Marcha de Glúteos en Suelo',          musculo: 'Glúteos/Core',      series: 2, reps: '10 c/lado',  descanso: '20 seg' },
    ],
  },
];
