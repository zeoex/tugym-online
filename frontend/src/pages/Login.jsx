...
const CAMPO_SX = {
  '& .MuiOutlinedInput-root': {
    ...
    '&.Mui-focused fieldset': { borderColor: { xs: '#4E9FFF', md: '#2F6FCB' } },
  },
  '& .MuiInputLabel-root': { color: { xs: 'rgba(255,255,255,0.6)', md: 'rgba(0,0,0,0.6)' } },
  '& .MuiInputLabel-root.Mui-focused': { color: { xs: '#4E9FFF', md: '#1D5AB8' } },
  /* El autocompletado de Chrome pisa color y fondo con los suyos. */
  '& input:-webkit-autofill': {
    WebkitTextFillColor: { xs: '#fff', md: 'rgba(0,0,0,0.87)' },
    WebkitBoxShadow: { xs: '0 0 0 100px #101B2E inset', md: '0 0 0 100px #fff inset' },
...
export default function Login() {
  ...
  return (
    <Box sx={{
      minHeight: '100vh',
      display: 'flex',
      background: 'linear-gradient(145deg, #070B14 0%, #0D1424 60%, #0B1220 100%)',
    }}>
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          background: 'radial-gradient(circle, rgba(78,159,255,0.15) 0%, transparent 70%)',
          top: '50%', left: '50%',
        ...
        <Box sx={{ position: 'relative', textAlign: 'center' }}>
          <Box sx={{
            width: 72, height: 72, borderRadius: 3, bgcolor: '#4E9FFF',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            mx: 'auto', mb: 3, boxShadow: '0 0 40px rgba(78,159,255,0.4)',
          }}>
            <FitnessCenterIcon sx={{ fontSize: 38, color: '#0D1424' }} />
          </Box>
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          background: 'radial-gradient(circle, rgba(78,159,255,0.18) 0%, transparent 70%)',
          top: '50%', left: '50%',
          transform: 'translate(-50%, -50%)',
          pointerEvents: 'none',
        }} />
        ...
        <Box sx={{
          ...
          <Box sx={{ display: { md: 'none' }, textAlign: 'center', mb: 3.5 }}>
            <Box sx={{
              ...
              mb: 1.5,
              boxShadow: '0 0 28px rgba(78,159,255,0.5)',
            }}>
              <FitnessCenterIcon sx={{ fontSize: 34, color: '#0D1424' }} />
            </Box>
          ...
          <Box component="form" onSubmit={handleSubmit} display="flex" flexDirection="column" gap={2.5}>
            ...
            <Button
              ...
              sx={{
                ...
                bgcolor: '#4E9FFF',
                color: '#0D1424',
                '&:hover': { bgcolor: '#2F88F2' },
                boxShadow: { xs: '0 0 20px rgba(78,159,255,0.4)', md: 'none' },
              }}
            >
